...
parser.add_argument('--testpath', default='/data1/wzz/dtu/',help='testing data path')
parser.add_argument('--testlist', default='/data1/wzz/test.txt',help='testing scan list')
...
parser.add_argument('--outdir', default='/data1/wzz/outputs_1032', help='output dir')
...
def filter_depth(scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        ref_img=cv2.resize(ref_img,(confidence.shape[1],confidence.shape[0]))

...
parser.add_argument('--testpath', default='/data1/wzz/tnt_changed/', help='testing data path')
...
parser.add_argument('--outdir', default='/data1/wzz/outputs_tnt_1032', help='output dir')
